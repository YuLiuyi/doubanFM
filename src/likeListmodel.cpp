...
//LikeList::LikeList(QObject *parent) : QAbstractListModel(parent)
//{
...
//int LikeList::rowCount(const QModelIndex & parent) const
//{
//    Q_UNUSED(parent);
...
//void LikeList::handleList(ChannelList filelist)
//{
//    beginResetModel();
...
//QVariant LikeList::data(const QModelIndex & index, int role) const
//{
//    qDebug()<<"=======data======";
...
//QString LikeList::getChannel_id(int index) const
//{
...
//int LikeList::getSeq_id(int index) const
//{
...
//QString LikeList::getName(int index) const
//{
...
//QHash<int, QByteArray> LikeList::roleNames() const
//{
//    qDebug() << Q_FUNC_INFO;
